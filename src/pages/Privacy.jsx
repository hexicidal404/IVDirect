export default function Privacy() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to IV Direct.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to IV Direct, accessible from{" "}
            <a
              href="https://www.iv.direct/"
      ...
      <ul>
        <li>
          <p>By email: info@iv.direct</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://www.iv.direct/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.iv.direct/contact
            </a>
          </p>
        </li>
      </ul>
